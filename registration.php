...
return true;
    ...
    echo $msg;
                              ...
                              <form action="" name="signup" method="post" onsubmit="return checkpass();">
                                 <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input type="password" class="form-control" id="password" value="" name="password" required="true" required="true" maxlength="12"> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputPassword1">Repeat password</label>
                                       <input type="password" class="form-control" id="repeatpassword" value="" name="repeatpassword" required="true" maxlength="12"> 
                                    </div>
                                                                     </div>
                     ...
                     <div class="col-md-4">
                        ...
                        <hr>
                        <img src="images/sinup.jpg" alt="" class="img-fluid">
                        <p></p>
