...
<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/fastfood.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Free Order Delivery.</h1>
        ...
        <div class="location-match text-xs-center">
            <div class="container"> <span><b>Popular Delicious Foods </b> <span class="primary-color"></span> </span>
            </div>
        </div>
...
?>
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            <div class="figure-wrap bg-image"><img src="admin/itemimages/<?php echo $row['Image'];?>" width="350" height="180">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Pay by Cash on delivery or through Card payment</p>
                    </div>
                </div>
            </div>
        </section>
