...
<h6><a href="food-detail.php?fid=<?php echo $_SESSION['fid']=$row['FoodId'];?>"><?php echo $row['ItemName']?> (<?php echo $row['ItemQty']?>) </a></h6>
                                        ...
                                        <!-- end:col -->
                                        <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info"> <span class="price pull-left">Rs. <?php echo $total=$row['ItemPrice']?></span> <img src="images/white.jpg" height="5" width="85"> <img src="images/wrong.jpg" height="20" width="20"></div>
                                    </div>
                                    <!-- end:row -->								
                                <?php 
$grandtotal+=$total;
                                ...
                                <div class="order-row bg-white">
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group row no-gutter">
                                            <div class="col-lg-12">
	<td> <b>Enter Shipping Address :</b> </td>
...
<input type="text" name="landmark" placeholder="Landmark if any" class="form-control" required="true"> 
<input type="text" name="city" placeholder="City name" class="form-control" required="true"> 
<input type="text" name="ph number" placeholder="Phone number optional" class="form-control" maxlength="10" pattern="[0-9]{10}">  <br> <br> <br>

<form method="post">

  <b> Please select a method of payment below :</b> <br> <br>
  <form> <label> <input value="1" type="radio" name="formselector" onclick="displayForm(this)"> <b>Cash On Delivery</b>(directly hit the place order) </label> <br>
                 <input value="2" type="radio" name="formselector" onclick="hiddenForm(this)"> <b>Card Payment</b>(enter the details given below)</label> <br>
   </form>
  <br> <br> 
</form>

<b>Card Payment :</b> <br>
  <td> <b> Full name</b>(on the card) :<input type="text" name="name" placeholder="name of card holder" class="form-control"> </td> <br>
   <td> <b>Card Type : </b> <select name="name" class="form-control"> 
      <option> Type </option>
	  <option> Visa </option>
      ...
      <option> Verified By Visa </option>
	  <option> Rupay </option> </td>
</select>  <br>
	  
	  
     <b>Enter Card Number :</b> 
  <td> <input type="card" placeholder="card number" class="form-control" id="cardNumber" maxlength="16" minlength="16" > </td> <br>
  
 <td> <b>Enter CVV/CVC :</b> </td>
<input type="password" placeholder="cvv" class="form-control" maxlength="3" minlength="3">  <br>
...
<span style="width:40%; text-aligh:center"> / </span>
  <select class="form-control" style="width:45%">
    <option> YY </option>
    <option> 2020 </option>
    <option> 2021 </option>
